...
head(
    page: "Database Error",
    description: "An error relating to the database connection has been thrown.",
    url: ""
);
...
echo <<<EOD
    <div class="flex justify-center items-center h-screen">
        <div class="{$CSS('WERD_WERDLY_BOX_CLASSES')} max-w-[30rem] mx-8">
            ...
            <span class="text-xl font-bold">Database Error</span>
            <span class="text-wrap">An error relating to the database connection has been thrown.</span>
            <div class="font-mono">
                {$FUNC("basic_code", WERD_ERROR_CODE)} {$CONST('WERD_ERROR')}
            </div>
